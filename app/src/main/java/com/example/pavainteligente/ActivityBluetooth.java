    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        public void onReceive(Context context,Intent intent) {
            ...
            //Si finalizo la busqueda de dispositivos bluethoot
                ...
                Intent newIntent = new Intent(ActivityBluetooth.this, DeviceListActivity.class);
            ...
            //si se encontro un dispositivo bluethoot
                ...
                if (ActivityCompat.checkSelfPermission(ActivityBluetooth.this, Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
    ...
    private View.OnClickListener btnEmparejarListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (pairedDevices == null || pairedDevices.size() == 0) {
                ...
                Intent intent = new Intent(ActivityBluetooth.this, DeviceListActivity.class);
